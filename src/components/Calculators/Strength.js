...
const Strength = () => {
  return (
    <section className='section-container'>
      <Intro title='Força e Velocidade - Cálculos e Fórmulas' text='A seção de força e velocidade é projetada para ajudar a calcular e entender conceitos relacionados à força, velocidade e outras medidas físicas. Aqui, você pode calcular a força, velocidade, aceleração e muito mais, com fórmulas e exemplos práticos para facilitar o entendimento.' />
      <FormulaContainer
...
<FormulaContainer
  ...
  example={'v = ΔS / Δt'}
  values={['v', 'ΔS', 'Δt']}
  inputIDs={['CalculoVelocidadeMedia-v', 'CalculoVelocidadeMedia-ΔS', 'CalculoVelocidadeMedia-Δt']}
  info={[
...
<FormulaContainer
  ...
  example={'a = Δv / Δt'}
  values={['a', 'Δv', 'Δt']}
  inputIDs={['CalculoAceleracaoMedia-a', 'CalculoAceleracaoMedia-Δv', 'CalculoAceleracaoMedia-Δt']}
  info={[
...
<FormulaContainer
  title={'Equação da Velocidade no Movimento Uniformemente Acelerado (MUV)'}
  example={'v = v₀ + a * t'}
  values={['v', 'v₀', 'a', 't']}
  inputIDs={['EquacaoVelocidadeMUV-v', 'EquacaoVelocidadeMUV-v₀', 'EquacaoVelocidadeMUV-a', 'EquacaoVelocidadeMUV-t']}
  info={[
...
<FormulaContainer
  ...
  values={['S', 'S₀', 'v₀', 't', 'a']}
  inputIDs={['EquacaoPosicaoMUV-S', 'EquacaoPosicaoMUV-S₀', 'EquacaoPosicaoMUV-v₀', 'EquacaoPosicaoMUV-t', 'EquacaoPosicaoMUV-a']}
  info={[
